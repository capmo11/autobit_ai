                ...
                turnMacdSignal = 1 #하락전환
							...
							if  (  ( beforeBlueValue.to_f < beforeRedValue.to_f ) && ( nowBlueValue.to_f > nowRedValue.to_f )  && (  conversionLineValue.to_f  <  lastValue.to_f  )    )
								puts 'Buy Sign!!!!!!!!!!'
									...
									@watir.execute_script('window.open("https://miraclepushserver.firebaseapp.com/?signal=buyBCHUSD&initValue='+initValue.to_s+'&highValue='+highValue.to_s+'&lowValue='+lowValue.to_s+'&lastValue='+lastValue.to_s+'&conversionLine='+conversionLineValue.to_s+'&nowBlueValue='+nowBlueValue.to_s+'&nowRedValue='+nowRedValue.to_s+'")')
									#							                       																																				  1                                       2                                                    3                                                          4                                                       5                                                                  6                                                                                        7                                                                      8                         
                  ...
                  sleep(2)
							...
							if  (  ( beforeBlueValue.to_f > beforeRedValue.to_f  ) && ( nowBlueValue.to_f < nowRedValue.to_f )  )
								puts 'Sell Sign!!!!!!!!!!'
								  @watir.execute_script('window.open("https://miraclepushserver.firebaseapp.com/?signal=sellBCHUSD&initValue='+initValue.to_s+'&highValue='+highValue.to_s+'&lowValue='+lowValue.to_s+'&lastValue='+lastValue.to_s+'&conversionLine='+conversionLineValue.to_s+'&nowBlueValue='+nowBlueValue.to_s+'&nowRedValue='+nowRedValue.to_s+'")')
									@watir.windows.last.close
									sleep(1)
									@watir.windows.first.use
									sleep(2)
