  ...
  def getChartTimeStamp
       begin
         ...
         if ( timeSecond == "40" )
           ...
           if( timeHour == "23" && timeMinute =="59" && timeSecond == "58"   )
               return "5IndexEnd"  
          elsif( (timeSecond == "58" && timeMinute == "59" && timeHour == "23" ) ||  (timeSecond == "58" && timeMinute == "59" && timeHour == "07" ) ||  (timeSecond == "58" && timeMinute == "59" && timeHour == "15" )  )
               return "4IndexEnd"
...
'+text.to_s)
 ...
 def krChartDataGettingInit
   begin
    ...
    buyOrSell_Signal_CalCulate( @krChartDTO_before_5Index  , @krChartDTO_5Index  , @interVal_5)
    sleep(3)
    # 
