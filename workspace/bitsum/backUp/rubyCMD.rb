...
class RubyCMD
  ...
  stdout, stdeerr, status = Open3.capture3("java -cp C:/eclipse/workspace/ApiClient/bin;C:/eclipse/workspace/ApiClient/lib/jackson-all-1.9.11.jar;C:/eclipse/workspace/ApiClient/lib/guava-18.0.jar;C:/eclipse/workspace/ApiClient/lib/commons-codec-1.10.jar javaApi.Main buy EOS")
